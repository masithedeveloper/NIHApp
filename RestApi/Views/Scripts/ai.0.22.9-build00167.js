...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.operationPersonId = "ai.operation.personId";
        ...
        var TelemetryContext = (function () {
            ...
            TelemetryContext.prototype._applyOperationContext = function (envelope, operationContext) {
                if (operationContext) {
                    ...
                    if (typeof operationContext.personId === "string") {
                        envelope.tags[tagKeys.operationPersonId] = operationContext.personId;
                    }
