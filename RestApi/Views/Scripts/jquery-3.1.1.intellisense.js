...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'stopPropagation': function() {
    /// <summary>Prevents the event from bubbling up the DOM tree, preventing any person handlers from being notified of the event.</summary>
  },
  'target': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'child': function() {
    /// <signature>
    ///   <summary>Selects all direct child elements specified by "child" of elements specified by "person".</summary>
    ///   <param name="person" type="String">Any valid selector.</param>
  ...
  'fadeOut': function() {
    /// <signature>
    ///   <summary>Hide the matched elements by fading them to transperson.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'first-child': function() {
    /// <summary>Selects all elements that are the first child of their person.</summary>
  },
  ...
  'last-child': function() {
    /// <summary>Selects all elements that are the last child of their person.</summary>
  },
  ...
  'next siblings': function() {
    /// <signature>
    ///   <summary>Selects all sibling elements that follow after the "prev" element, have the same person, and match the filtering "siblings" selector.</summary>
    ///   <param name="prev" type="String">Any valid selector.</param>
  ...
  'nth-child': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth-child of their person.</summary>
  ...
  'nth-last-child': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth-child of their person, counting from the last element to the first.</summary>
  ...
  'nth-of-type': function() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth child of their person in relation to siblings with the same element name.</summary>
  ...
  'only-child': function() {
    /// <summary>Selects all elements that are the only child of their person.</summary>
  },
  ...
  'person': function() {
    /// <signature>
    ///   <summary>Get the person of each element in the current set of matched elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'position': function() {
    /// <summary>Get the current coordinates of the first element in the set of matched elements, relative to the offset person.</summary>
    /// <returns type="Object" />
  },
  'prepend': function() {
    /// <signature>
  ...
  'unwrap': function() {
    /// <summary>Remove the persons of the set of matched elements from the DOM, leaving the matched elements in their place.</summary>
    /// <returns type="jQuery" />
  },
  'val': function() {
    /// <signature>
